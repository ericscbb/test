...
{ GPIO_Mode_AIN = 0x0,	 		//模擬輸入
  GPIO_Mode_IN_FLOATING = 0x04,	//浮空輸入(復位狀態)
  GPIO_Mode_IPD = 0x28,			//下拉輸入
  GPIO_Mode_IPU = 0x48,			//上拉輸入
  GPIO_Mode_Out_OD = 0x14,		//通用輸出開漏
  GPIO_Mode_Out_PP = 0x10,		//通用輸出推挽
  GPIO_Mode_AF_OD = 0x1C,		//復用功能輸出開漏
  GPIO_Mode_AF_PP = 0x18		//復用功能輸出推挽
}GPIOMode_TypeDef;
